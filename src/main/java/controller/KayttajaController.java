...
public class KayttajaController {
    ...
    public void lisaaKayttaja(String etunimi, String sukunimi, String sposti, String puh, String rooli, String salasana) {
        ...
        Kayttaja kayttaja = new Kayttaja(0, etunimi, sukunimi, sposti, puh, rooli, hashedPassword);// kayttajaId is set to 0, as it should be auto-generated by the DB
        // Hash the password using BCrypt
        //String hashedPassword = BCrypt.hashpw(salasana, BCrypt.gensalt());
    ...
    public void vaihdaSalasana(String sposti, String newPassword) {
